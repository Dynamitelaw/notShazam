...
std::vector<std::vector<int>> read_fft(std::string filename);

std::list<hash_pair> hash_create(std::string song_name);

std::list<peak> max_bins(std::vector<std::vector<int>> fft, int nfft);

std::list<peak_raw> get_peak_max_bin(std::vector<std::vector<int>> fft, 
